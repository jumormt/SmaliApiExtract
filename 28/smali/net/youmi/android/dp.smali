...
.method constructor <init>(Lnet/youmi/android/cc;)V
    ...
    iput-object p1, p0, Lnet/youmi/android/dp;->a:Lnet/youmi/android/cc;
...
.method a()Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Lnet/youmi/android/dp;->b:Landroid/graphics/drawable/Drawable;

    if-nez v0, :cond_0

    const-string v0, "last.png"

    invoke-virtual {p0, v0}, Lnet/youmi/android/dp;->a(Ljava/lang/String;)Landroid/graphics/drawable/Drawable;

    move-result-object v0

    const-string v1, "last-enable.png"

    invoke-virtual {p0, v1}, Lnet/youmi/android/dp;->a(Ljava/lang/String;)Landroid/graphics/drawable/Drawable;

    move-result-object v1

    invoke-virtual {p0, v0, v1}, Lnet/youmi/android/dp;->a(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;

    move-result-object v0

    iput-object v0, p0, Lnet/youmi/android/dp;->b:Landroid/graphics/drawable/Drawable;
...
.method a(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {}, Lnet/youmi/android/cc;->a()[I
    ...
    invoke-static {}, Lnet/youmi/android/cc;->b()[I
    ...
    invoke-static {}, Lnet/youmi/android/cc;->c()[I
...
.method b()Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Lnet/youmi/android/dp;->c:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v0, p0, Lnet/youmi/android/dp;->c:Landroid/graphics/drawable/Drawable;
...
.method c()Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Lnet/youmi/android/dp;->f:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v0, p0, Lnet/youmi/android/dp;->f:Landroid/graphics/drawable/Drawable;
...
.method d()Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Lnet/youmi/android/dp;->e:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v0, p0, Lnet/youmi/android/dp;->e:Landroid/graphics/drawable/Drawable;
...
.method e()Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Lnet/youmi/android/dp;->d:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v0, p0, Lnet/youmi/android/dp;->d:Landroid/graphics/drawable/Drawable;

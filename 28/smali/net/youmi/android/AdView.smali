...
.field private i:Lnet/youmi/android/ct;

.field private j:Lnet/youmi/android/ey;
...
.method public constructor <init>(Landroid/app/Activity;)V
    ...
    invoke-direct {v0, p0}, Lnet/youmi/android/cd;-><init>(Lnet/youmi/android/AdView;)V

    iput-object v0, p0, Lnet/youmi/android/AdView;->k:Lnet/youmi/android/z;
...
.method a(Landroid/app/Activity;Landroid/util/AttributeSet;IIII)V
    ...
    iput-object v0, p0, Lnet/youmi/android/AdView;->d:Lnet/youmi/android/bz;
    :try_end_0
...
.method a(Lnet/youmi/android/ct;)V
    ...
    :cond_1
    iget-object v0, p0, Lnet/youmi/android/AdView;->i:Lnet/youmi/android/ct;
    ...
    :cond_2
    iput-object p1, p0, Lnet/youmi/android/AdView;->i:Lnet/youmi/android/ct;
    ...
    invoke-virtual {v0, p1}, Lnet/youmi/android/fb;->b(Lnet/youmi/android/ct;)V
...
.method b()Lnet/youmi/android/bz;
    ...
    iget-object v0, p0, Lnet/youmi/android/AdView;->d:Lnet/youmi/android/bz;

    return-object v0
.end method

.method c()Lnet/youmi/android/ct;
    .locals 1
...
.method e()V
    ...
    invoke-static {v0}, Lnet/youmi/android/cy;->a(Landroid/app/Activity;)I
    ...
    invoke-static {v0, p0}, Lnet/youmi/android/aj;->a(Landroid/app/Activity;Lnet/youmi/android/AdView;)V
    :try_end_0
    ...
    invoke-static {v0}, Lnet/youmi/android/cy;->b(Landroid/app/Activity;)Lnet/youmi/android/ct;

    move-result-object v0

    invoke-virtual {p0, v0}, Lnet/youmi/android/AdView;->a(Lnet/youmi/android/ct;)V
    ...
    invoke-static {v0}, Lnet/youmi/android/cy;->e(Landroid/app/Activity;)Lnet/youmi/android/ct;
    ...
    invoke-static {v0}, Lnet/youmi/android/cy;->c(Landroid/app/Activity;)Lnet/youmi/android/ct;
    ...
    invoke-static {v0}, Lnet/youmi/android/cy;->f(Landroid/app/Activity;)Lnet/youmi/android/ct;
    ...
    invoke-static {v0}, Lnet/youmi/android/cy;->g(Landroid/app/Activity;)Lnet/youmi/android/ct;
    ...
    invoke-static {v0}, Lnet/youmi/android/cy;->d(Landroid/app/Activity;)Lnet/youmi/android/ct;
...
.method f()V
    ...
    new-instance v1, Lnet/youmi/android/cj;

    invoke-direct {v1, p0}, Lnet/youmi/android/cj;-><init>(Lnet/youmi/android/AdView;)V
...
.method g()V
    ...
    new-instance v1, Lnet/youmi/android/cg;

    invoke-direct {v1, p0}, Lnet/youmi/android/cg;-><init>(Lnet/youmi/android/AdView;)V
...
.method h()V
    ...
    invoke-direct {v1, p0}, Lnet/youmi/android/cl;-><init>(Lnet/youmi/android/AdView;)V
...
.method protected onAttachedToWindow()V
    ...
    invoke-virtual {v0}, Lnet/youmi/android/bz;->a()Lnet/youmi/android/w;
    ...
    iget-object v3, p0, Lnet/youmi/android/AdView;->d:Lnet/youmi/android/bz;
    ...
    iget-object v1, p0, Lnet/youmi/android/AdView;->k:Lnet/youmi/android/z;

    const/4 v2, -0x1

    invoke-direct {v0, v1, v2}, Lnet/youmi/android/ey;-><init>(Lnet/youmi/android/z;I)V

    iput-object v0, p0, Lnet/youmi/android/AdView;->j:Lnet/youmi/android/ey;
    :try_end_3
...
.method protected onDetachedFromWindow()V
    ...
    :try_start_0
    iget-object v0, p0, Lnet/youmi/android/AdView;->j:Lnet/youmi/android/ey;
